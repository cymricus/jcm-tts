...
const US_SSML_EXPRESSIVE = '<speak><express-as type="GoodNews"><voice-transformation type="Custom" rate="33%">Thank you for calling company name.</voice-transformation></express-as>
<break strength="medium">medium pause</break>
<express-as type="Apology">We are currently assisting</express-as> other customers. If you know the extension of the <voice-transformation type="Custom" rate="20%"> person you are trying</voice-transformation> to reach<break strength="weak">weak pause</break>you may dial it now<break strength="weak">weak pause</break> or choose from <voice-transformation type="Custom" rate="25%">one of the following options.</voice-transformation><break strength="medium">medium pause</break>Press 1 for the <voice-transformation type="Custom" rate="25%">dial by name directory.</voice transformation><break strength="weak">weak pause</break>Press 9 to leave a message <voice-transformation type="Custom" rate="25%">in the general mailbox </voice-transformation>and we will get back to you <voice-transformation type="Custom" rate="33%">as soon as possible.</voice-transformation><break strength="weak">weak pause</break>Press star to <voice-transformation type="Custom" rate="25%">repeat this message.</voice-transformation><break strength="weak">weak pause</break><express-as type="GoodNews"><voice-transformation type="Custom" rate="33%">Thanks again for calling company name.</voice-transformation></express-as><break strength="x-strong">x-strong pause</break><prosody volume="x-soft">good-bye</prosody></speak>';
